...
export function ChatInput({
  ...
  useEffect(() => {
    ...
    // when agent is available, refocus on input
  ...
  return (
    <motion.div
      ...
      className="border-gold/30 flex w-full items-start overflow-hidden border-b bg-transparent"
    >
      <form
      ...
      >
        ...
        <Button
          ...
          className={`self-start ${!isDisabled ? 'bg-gold hover:bg-gold-dark text-primary-foreground' : ''}`}
        >
          {isSending ? (
